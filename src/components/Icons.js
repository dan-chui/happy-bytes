...
export const CodeSlashIcon = ({ className, ...rest }) => (
  <svg
  ...
  >
    <path
      fill="#000"
      d="M13.325 3.05 8.668 20.432l1.932.518 4.657-17.382-1.932-.518ZM7.612 18.36l1.36-1.448v-.019l-5.095-4.78 4.79-5.105L7.21 5.639l-6.16 6.563 6.563 6.159ZM16.388 18.36l-1.36-1.448.001-.019 5.095-4.78-4.79-5.105 1.458-1.369 6.159 6.563-6.563 6.159Z"
    />
  </svg>
);

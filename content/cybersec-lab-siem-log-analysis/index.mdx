...
image: "../../public/blogs/article_images/20.webp"
...
## 🧪 Scenario 1: Log4j Vulnerability Analysis (HTTP)
...
- **CyberChef** – decoding and transforming obfuscated payloads
...
<Image
  src="/blogs/labs/siem_log/log4j_http_cleartext_02.webp"
  alt="Start of Log4j attack phase"
  width={0}
  height={0}
  sizes="100vw"
...
- **Splunk** – correlating events, timestamps, and source IPs
- **Wireshark** – identifying abnormal HTTP POST behavior
...
📊 This scenario highlights how **SIEM + network visibility** work together in a SOC environment.
...
<Image
  src="/blogs/labs/siem_log/data_exfil_1.webp"
  alt="Outbound POST requests"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  src="/blogs/labs/siem_log/data_exfil_3.webp"
  alt="Wireshark packet details"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
- SIEM Log Analysis Report (PDF) Download ⬇️
  <a
    href="/blogs/labs/siem_log/SIEM_Log_Analysis_Report_Complete.pdf"
    target="_blank"
    rel="noopener"
    download
  >
...
🔗 Full report and supporting files available on [GitHub](https://github.com/dan-chui/SIEM-Incident-Analysis-Report)

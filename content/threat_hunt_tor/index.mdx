...
This investigation follows a structured analyst workflow from detection to validation and risk assessment.
...
The investigation relied on **Microsoft Defender XDR Advanced Hunting (KQL)Microsoft Defender Advanced Hunting** and several telemetry tables:

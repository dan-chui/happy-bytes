...
- Incident Escalation Playbook Report (PDF) Download ⬇️
  <a
    href="/blogs/labs/incident_escalation_playbook/Incident_Escalation_Playbook_Final.pdf"
    target="_blank"
    rel="noopener"
    download
  >
...
🔗 Full report and supporting files available on [GitHub](https://github.com/dan-chui/Incident-Escalation-Playbook-Report)
